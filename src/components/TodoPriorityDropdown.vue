<template>
  <div
    class="relative w-36 select-none rounded-full border-2 border-black bg-white py-[0.1rem] text-center"
  >
    ...
    <div
      class="absolute box-border w-32 translate-y-4 select-none rounded-xl border-2 border-black bg-white text-center"
    >
